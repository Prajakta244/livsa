...
const Register = () => {
    ...
    return (
        <>
            <div class="flex flex-col items-center mt-2 lg:mt-2 max-w-7xl mx-auto pt-20 px-20">
                <h1 class="text-2xl sm:text-3xl lg:text-5xl text-center tracking-wide">
                ...
                <p className='mb-5 mt-5 sm:mt-0'>Please choose the category of your hospital !</p>
